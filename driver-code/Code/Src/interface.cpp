...
static inline size_t write_readout_values(uint8_t * buffer, Readout const& readout) {
    ...
    offset += 2;
    write_int16(buffer + offset, readout.u_current);
    offset += 2;
    write_int16(buffer + offset, readout.v_current);
    offset += 2;
    write_int16(buffer + offset, readout.w_current);
    offset += 2;
    write_uint16(buffer + offset, readout.ref_readout);
    offset += 2;
    write_int16(buffer + offset, readout.u_current_diff);
    offset += 2;
    write_int16(buffer + offset, readout.v_current_diff);
    offset += 2;
    write_int16(buffer + offset, readout.w_current_diff);
    offset += 2;
