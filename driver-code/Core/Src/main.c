...
See app_main.cpp for the main application code.

This file is mostly autogenerated by STM32CubeMX. However the autogenerated settings are 
minimally altered by app_main. Mind this file as a reference for the hardware setup!

(Obviously, only code between the USER CODE BEGIN and USER CODE is custom,
the rest will be modified by STM32CubeMX and should not be edited by hand!)
*/
