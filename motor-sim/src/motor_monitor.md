...
const command_pwm_slider = inputs_wide_range([0, PWM_BASE], {value: PWM_BASE * 0.05, step: 1, label: "Command value:"});
...
const current_calibration_gradients = current_calibration_iteration?.sample ?? [];
