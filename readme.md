...
(TODO: this section needs updating to include the master circuit and master code and versioning and media and circuit libraries layout)
...
Lessons learnt for driver code v0.4
-----------------------------------

[ ] VREF must be independent of the reference to the amplifier; and actually well insulated. The v0.2 and v0.3 are too noisy because of this I suspect.
[ ] Let's go back to USB with 5V and separate VCC power connector! Also allows us to drop the on-board buck converter and save space. Bonus for easy to
control from a computer/phone with any USB cable.
